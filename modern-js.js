...
for(let i = 0; i < buses.length; i++) {
    console.log(buses[i].route, buses[i].passengers, buses[i].late); //เขียนแบบ classic
}
...
const lateBuses = buses.fitter(({late}) => late==true);
const heavyBuses = buses.fitter(({passengers}) => 50);
